...
document.querySelector('#footer-part').innerHTML = `        `;


document.querySelector('#top-part').innerHTML = `<div class="col-lg-4 col-md-4">
                        <div class="logo">
                            <a href="index.html">
                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="support-button float-right d-none d-md-block">
                            <div class="support float-left">
                                ...
                                <div class="cont">
                                    <p>Need Help to advertise with us? Call us anytime</p>
                                    <span onclick='location.href="tel:+255 716 312 255"'>+255 716 312 255</span>
                                </div>
                            </div>
                            <div class="button float-left">
                                <button class="main-btn" onclick="checkAuth()">MyAccount</button>
                            </div>
                        </div>
                    </div>`;
...
// document.querySelector('#admin-part').innerHTML = `<div class="right-icon text-right">
//                 <ul>
//                     <li>
//                         <button class="main-btn" onclick="checkAuth()">Admin</button>
//                     </li>
