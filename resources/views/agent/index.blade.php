                            ...
                            <table class="table table-sm table-nowrap table-hover card-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="products-sales">Customer</td>
                                        <td class="malafyale1">Shabiru</td>
                                        <td class="malafyale1">2017</td>
                                    </tr>
                                    <tr>
                                        <td class="products-product">
                                            <div class="d-flex align-items-center">
                                                <div class="ms-3">
                                                    <!-- Heading -->
                                                    <h4 class="fw-normal mb-1">Kelvin bryton</h4>
                                                    <!-- Text -->
                                                    <small class="text-body-secondary">Mwamsiku</small>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="products-stock">078876456342</td>
                                        <td class="products-price">stuartsmg7@gmail.com</td>
                                        <td class="products-sales">customer</td>
                                        <td class="malafyale1">aubert</td>
                                        <td class="malafyale1">2019</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
