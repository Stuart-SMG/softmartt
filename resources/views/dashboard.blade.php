                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <p class="text-body-secondary mb-0">
                                This is a description of this task. Lorem ipsum dolor sit amet, consectetur adipiscing
                                elit. Vestibulum
                                magna nisi, ultrices ut pharetra eget.
                            </p>
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col ms-n2">
                                    ...
                                    <!-- Form -->
                                    <form class="mt-1">
                                        <textarea class="form-control form-control-flush form-control" data-autosize
                                    ...
                                    <div class="col ms-n2">
                                        ...
                                        <div class="comment-body">
                                            ...
                                            <p class="comment-text">
                                                ...
                                                like a lot to process and
                                                doesn't really <em>show</em> me what the product does? I think using a
                                                short looping video or
                                                something similar demo'ing the product might be better?
                                            </p>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href="#sidebarDashboards" role="button" aria-expanded="true"
                                ...
                                <i class="fe fe-home"></i> Dashboardss
                            </a>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="sidebarAuth">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <!-- Password reset -->
                            <li class="nav-item">
                                <a href="#sidebarPassword" class="nav-link" data-bs-toggle="collapse" role="button"
        ...
        <nav class="navbar navbar-vertical navbar-vertical-sm fixed-start navbar-expand-md" id="sidebarSmall">
            <div class="container-fluid">
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                    data-bs-target="#sidebarSmallCollapse" aria-controls="sidebarSmallCollapse" aria-expanded="false"
            ...
            mx-auto" alt="...">
                ...
                <div class="navbar-user d-md-none">
                    ...
                    <div class="dropdown">
                        ...
                        <!-- Toggle -->
                        <a href="#" id="sidebarSmallIcon" class="dropdown-toggle" role="button"
                ...
                <div class="collapse navbar-collapse" id="sidebarSmallCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropend">
                            <a class="nav-link dropdown-toggle " id="sidebarSmallPages" href="#"
                        ...
                        <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right"
                            ...
                            <a class="nav-link " href="widgets.html">
                                <i class="fe fe-grid"></i> <span class="d-md-none">Widgetss</span>
                            </a>
                        </li>
                        <li class="nav-item dropend">
                            <a class="nav-link dropdown-toggle" id="sidebarSmallAuth" href="#" data-bs-toggle="dropdown"
                        ...
                        <li class="nav-item d-md-none">
                            <a class="nav-link" href="#sidebarOffcanvasActivity" data-bs-toggle="offcanvas"
                                aria-controls="sidebarOffcanvasActivity">
                                <span class="fe fe-bell"></span> Notifications
                            </a>
                        </li>
                    ...
                    <ul class="navbar-nav mb-md-4">
                        <li class="nav-item dropend">
                            <a class="nav-link dropdown-toggle " id="sidebarSmallBasics" href="#"
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="docs/components.html" data-bs-toggle="tooltip"
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="docs/changelog.html" data-bs-toggle="tooltip"
                                data-bs-placement="right"
                                data-template='<div class="tooltip d-none d-md-block" role="tooltip"><div class="arrow"></div><div class="tooltip-inner"></div></div>'
                                title="Changelog">
                                <i class="fe fe-git-branch"></i> <span class="d-md-none">Changelog</span> <span
                                    class="badge bg-primary ms-auto d-md-none">v2.3.0</span>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="container">
                                    ...
                                    <a class="list-group-item" href="team-overview.html">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col ms-n2">
                                                ...
                                                <!-- Time -->
                                                <p class="small text-body-secondary mb-0">
                                                    <span class="fe fe-clock"></span> <time
                                                        datetime="2018-05-24">Updated 2hr ago</time>
                                                </p>
                                    ...
                                    <a class="list-group-item" href="project-overview.html">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col ms-n2">
                                                ...
                                                <p class="small text-body-secondary mb-0">
                                                    <span class="fe fe-clock"></span> <time
                                                        datetime="2018-05-24">Updated 4hr ago</time>
                                                </p>
                ...
                <div class="navbar-user">
                    ...
                    <div class="dropdown me-4 d-none d-lg-flex">
                        ...
                        <!-- Toggle -->
                        <a href="#" class="navbar-user-link" role="button" data-bs-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <a class="list-group-item text-reset" href="#!">
                                        <div class="row">
                                            ...
                                            <div class="col ms-n2">
                                                ...
                                                <!-- Content -->
                                                <div class="small">
                                                    <strong>Adolfo Hess</strong> commented <blockquote class="mb-0">“I
                                                        don’t think this really
                                                        makes sense to do without approval from Johnathan since he’s the
                                                        one...” </blockquote>
                                                </div>
                                    ...
                                    <a class="list-group-item text-reset" href="#!">
                                        <div class="row">
                                            ...
                                            <div class="col ms-n2">
                                                ...
                                                <!-- Content -->
                                                <div class="small">
                                                    <strong>Glen Rouse</strong> commented <blockquote class="mb-0">“I
                                                        don’t think this really
                                                        makes sense to do without approval from Johnathan since he’s the
                                                        one...” </blockquote>
                                                </div>
                    ...
                    <ul class="navbar-nav me-lg-auto">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="topnavDashboards">
                                ...
                                <li>
                                    <a class="dropdown-item active" href="dashboard-ecommerce.html">
                                        E-Commerce
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="offcanvas" href="#offcanvasDemo"
                                aria-controls="offcanvasDemo">
                                Customize
                            </a>
                        </li>
                                    ...
                                    <a class="list-group-item text-reset" href="#!">
                                        <div class="row">
                                            ...
                                            <div class="col ms-n2">
                                                ...
                                                <!-- Content -->
                                                <div class="small"><strong>Daniela Dewitt</strong> subscribed to you.
                                                </div>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center gx-0">
                            ...
                            <div class="col-auto">
                                ...
                                <!-- Icon -->
                                <span class="h2 fe fe-home text-body-secondary mb-0"></span>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center gx-0">
                            ...
                            <div class="col-auto">
                                ...
                                <!-- Icon -->
                                <span class="h2 fe fe-map text-body-secondary mb-0"></span>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center gx-0">
                            ...
                            <div class="col-auto">
                                ...
                                <!-- Icon -->
                                <span class="h2 fe fe-key text-body-secondary mb-0"></span>
...
<!-- Mirrored from dashkit.goodthemes.co/dashboard-ecommerce.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Mar 2025 07:33:37 GMT -->
